...
const ChartProduction: React.FC<ChartProductionProps> = ({
  ...
  const indicateurLabel = getFieldLabel('production-valeur-electricite', selectedIndicateur, indicateurOptions.find((o) => o.key === selectedIndicateur)?.label ?? selectedIndicateur);
