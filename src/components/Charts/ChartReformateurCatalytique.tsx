...
const ChartReformateurCatalytique: React.FC<ChartReformateurCatalytiqueProps> = ({
  ...
  }, [data, duration, selectedIndicateur, indicateurLabel, selectedMonthProp, selectedQuarterProp, selectedSemesterProp, selectedYearProp, weekReformateurData, monthReformateurData, quarterReformateurData, semesterReformateurData, yearReformateurData]);
